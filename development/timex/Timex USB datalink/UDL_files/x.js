// x.js
// X v3.12, Cross-Browser DHTML Library from Cross-Browser.com
...
function xShow(e) {
  ...
  if(e.style && xDef(e.style.visibility)) e.style.visibility='visible'; // v3.12, e.style.visibility='inherit';
...
function xLeft(e,iX) {
  ...
  if (css && xDef(e.style.left) && typeof(e.style.left)=="string") {
    if(arguments.length>1) e.style.left=iX+"px";
      ...
      if (xDef(e.offsetLeft)) iX = e.offsetLeft; // v3.12
...
function xTop(e,iY) {
  ...
  if(css && xDef(e.style.top) && typeof(e.style.top)=="string") {
    if(arguments.length>1) e.style.top=iY+"px";
      ...
      if (xDef(e.offsetTop)) iY = e.offsetTop; // v3.12
      else iY=parseInt(e.style.top);
      if(isNaN(iY)) iY=0;
    }
  }
...
function xOffsetLeft(e) { /* perhaps omit these, see change in xLeft/xTop v3.12 */
  if (!(e=xGetElementById(e))) return 0;
...
/* moved xLayer() and xLayerFromPoint() to x_util.js, v3.12 */
function xParent(e){
